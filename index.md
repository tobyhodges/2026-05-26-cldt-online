...
humandate: "26 - 29 May, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "12:00 - 16:00 UTC (14:00 - 18:00 CEST)"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2026-05-26      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-05-29        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Aleksandra Nenadic", "Jannetta Steyn", "Toby Hodges"] # boxed, comma-separated list of trainers' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
etherpad:  https://codimd.carpentries.org/2026-05-26-cldt-online           # optional: URL for the workshop CodiMD/Etherpad if there is one
...
<h3>What to expect in the training</h3>
...
<p>
The training focusses on backward lesson design, techniques for the development of effective exercises and accessible lesson content, and practices for better collaboration.
...
In a checkout process to complete their Lesson Developer certification, participants will reflect on the experience of teaching some their new lesson, and discuss how they will approach the remaining stages of lesson development.
</p>
...
<p>
  Please see <a href="{{ site.lessondev_training_site }}/instructor/index.html#schedule">the Lesson Developer Training Curriculum</a> for course material and sample schedule for a 4 half-day event.
</p>
...
<p>
  Before attending the training, please fill out <a href="{{ site.lessondev_pre_survey }}">our pre-training survey</a>.
</p>


<p>
  After the training, please fill out <a href="{{ site.lessondev_post_survey }}">our post-training survey</a>.
</p>
